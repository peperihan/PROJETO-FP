    ...
    while True:
        ...
        if escolha == "1":
            ...
            while peso_atual != peso_objetivo:
                ...
                banco["Metas"]["Perder Peso"]["atual"] = novo_peso_atual
        ...
        #---------------------------------------
            ...
            while distancia_atual != distancia_objetivo:
                ...
                banco["Metas"]["Distância"]["atual"] = nova_distancia_atual
        ...
        #---------------------------------------
            ...
            while massa_atual != massa_objetivo:
                ...
                banco["Metas"]["Ganho de Massa Muscular"]["atual"] = nova_massa_atual
